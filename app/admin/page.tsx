  ...
  return (
    <main className="min-h-screen bg-gray-100 p-10">
      <div className="mx-auto max-w-4xl rounded-3xl bg-white p-10 shadow-xl">
        <h1 className="mb-2 text-4xl font-bold text-gray-900">Painel administrativo</h1>
        ...
        <button
          ...
          disabled={loading}
          className="mt-8 rounded-2xl bg-green-600 px-8 py-4 font-bold text-white disabled:opacity-60 cursor-pointer"
        >
