            ...
            {loading && (
              <div className="bg-white rounded-2xl border border-gray-200 h-full min-h-[320px] flex flex-col items-center justify-center gap-4 p-8">
                ...
                <div className="text-center">
                  <p className="font-bold text-gray-700">IA ZH trilogy trabalhando...</p>
                  <p className="text-sm text-gray-400 mt-1">Analisando seus dados na ZH e criando a campanha perfeita</p>
                </div>
              </div>
            )}
