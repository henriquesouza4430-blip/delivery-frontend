  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <nav className="border-b border-slate-800 px-6 py-4">
        <div className="mx-auto flex max-w-7xl items-center justify-between">
          <div className="flex items-center gap-2">
            <span className="text-2xl font-black text-red-500">🍽️ ZH Sistema de Delivery</span>
          </div>
      ...
      <section className="px-6 py-20 bg-slate-900 text-center">
        <div className="mx-auto max-w-2xl">
          ...
          <p className="mb-8 text-slate-400">
            Junte-se aos demais restaurantes que já utilizam o ZH Sistema de Delivery.
          </p>
          <Link
            href="/signup"
      ...
      <footer className="border-t border-slate-800 px-6 py-8 text-center text-slate-500 text-sm">
        © {new Date().getFullYear()} ZH Sistema de Delivery. Todos os direitos reservados.
      </footer>
    </div>
  );
}