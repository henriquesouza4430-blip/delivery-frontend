    ...
    <main className="min-h-screen bg-gray-50 flex">
      ...
      <div className="hidden lg:flex w-1/2 bg-orange-500 flex-col items-center justify-center p-12 text-white">
        <div className="flex items-center gap-3 mb-8">
          ...
          <span className="text-3xl font-black tracking-tight">ZH Sistema de Delivery e Gestao de Cardapio</span>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-sm">
          ...
          <div className="flex items-center gap-2 mb-8 lg:hidden">
            ...
            <span className="text-xl font-black text-gray-900">ZH Sistema de Delivery e Gestao de Cardapio</span>
          </div>

          <h1 className="text-2xl font-black text-gray-900 mb-1">Bem-vindo de volta a plataforma ZH Sistema de Delivery e Gestao de Cardapio</h1>
