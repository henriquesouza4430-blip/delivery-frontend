        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-500 mt-1 text-sm">
              Conecte marketplaces. O ZH Sistema de Delivery é o dono do pedido — iFood vira apenas uma fonte de entrada.
            </p>
          </div>
          <button
            onClick={load}
        ...
        {!loading && tab === "catalog" && (
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
            ...
            <p className="text-sm text-gray-500 mb-6">
              Associe o ID de cada produto no marketplace ao produto interno do ZH Sistema de Delivery.
