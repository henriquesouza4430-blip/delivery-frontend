...
export function DemoCentralCard({ variant = "light" }: { variant?: "light" | "dark" }) {
  ...
  async function configureAI() {
    ...
    try {
      ...
      localStorage.setItem("impersonating", JSON.stringify({ companyName: "ZH Sistema de Delivery Plataforma", companyId: data.user.companyId }));
